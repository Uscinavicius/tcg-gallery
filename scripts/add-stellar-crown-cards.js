// This script adds Stellar Crown cards from the Pokémon TCG API to the database
...
async function main() {
  try {
    console.log("Starting to add Stellar Crown cards...");

    // Get cards from Pokémon TCG API for Stellar Crown (sv7)
    ...
    console.log(`Found ${apiCards.length} Stellar Crown cards in the API`);
    ...
    console.log(`Finished adding Stellar Crown cards!`);
    console.log(
